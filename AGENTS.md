...
- **Réponses par défaut : le plus court possible** (souvent 1 phrase + éventuellement 2–3 puces ; pas de pavés, pas de « résumés kilomètres », pas de répétition entre paragraphes). Détailler ou lister au long **uniquement** si l’utilisateur le demande explicitement.
